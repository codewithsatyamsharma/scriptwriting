...
* **CSS3:** Custom CSS variables, Flexbox/Grid layouts, and modular styling. Uses Remix Icons and Google Fonts.
* **Vanilla JavaScript (ES6+):** DOM manipulation, event delegation, state management, and `localStorage` integration.

---
Open your browser to the provided local host address (e.g., https://vercel.com/satyam-sharma-s-projects/scriptwriting).
